	...
	var b = r(function (z) {
			...
			var gt = {
				...
				yt = (_.___errno_location = function () {
					return (yt = _.___errno_location = _.asm.J).apply(null, arguments)
				}),
				bt = (_.___getTypeName = function () {
					return (bt = _.___getTypeName = _.asm.K).apply(null, arguments)
				})
			...
			var vt,
				wt = (_._malloc = function () {
					return (wt = _._malloc = _.asm.M).apply(null, arguments)
				}),
