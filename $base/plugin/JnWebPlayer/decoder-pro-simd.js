;((e, t) => {
	...
	var b = r(function (z) {
			var t,
				...
				j =
					($
						? ((e = h ? xt.default.dirname(e) + '/' : __dirname + '/'),
							(O = () => {
			...
			function fe(e) {
				;(this.excPtr = e),
					...
					(this.get_exception_ptr = function () {
						var e
						return St(this.get_type()) ? p[this.excPtr >> 2] : 0 !== (e = this.get_adjusted_ptr()) ? e : this.excPtr
					})
			}
			le((c = 'decoder-pro-simd.wasm')) || ((G = c), (c = _.locateFile ? _.locateFile(G, e) : e + G))
			var v = {
					isAbs: e => '/' === e.charAt(0),
					...
					basename: e => {
						var t
						return '/' === e ? '/' : -1 === (t = (e = (e = v.normalize(e)).replace(/\/$/, '')).lastIndexOf('/')) ? e : e.substr(t + 1)
					},
					join: function () {
				...
				S = {
					...
					nodePermissions: (e, t) =>
						S.ignorePermissions || ((!t.includes('r') || 292 & e.mode) && (!t.includes('w') || 146 & e.mode) && (!t.includes('x') || 73 & e.mode))
							? 0
							: 2,
					mayLookup: e => S.nodePermissions(e, 'x') || (e.node_ops.lookup ? 0 : 2),
					mayCreate: (e, t) => {
						try {
					...
					mayOpen: (e, t) =>
						e
							...
							: 44,
					MAX_OPEN_FDS: 4096,
					nextfd: (e = 0, t = S.MAX_OPEN_FDS) => {
						for (var r = e; r <= t; r++) if (!S.streams[r]) return r
					...
					syncfs: (t, r) => {
						'function' == typeof t && ((r = t), (t = !1)),
							S.syncFSRequests++,
							1 < S.syncFSRequests &&
								o('warning: ' + S.syncFSRequests + ' FS.syncfs operations in flight at once, probably just doing extra work')
					...
					mount: (e, t, r) => {
						...
						if (!n && !s) {
							...
							if (((r = s.path), S.isMountpoint((i = s.node)))) throw new S.ErrnoError(10)
					...
					ftruncate: (e, t) => {
						e = S.getStream(e)
						if (!e) throw new S.ErrnoError(8)
						if (!(2097155 & e.flags)) throw new S.ErrnoError(28)
						S.truncate(e.node, t)
					},
					utime: (e, t, r) => {
						e = S.lookupPath(e, { follow: !0 }).node
					...
					write: (e, t, r, i, n, s) => {
						if (i < 0 || n < 0) throw new S.ErrnoError(28)
						if (S.isClosed(e)) throw new S.ErrnoError(8)
						if (!(2097155 & e.flags)) throw new S.ErrnoError(8)
						if (S.isDir(e.node.mode)) throw new S.ErrnoError(31)
					...
					mmap: (e, t, r, i, n) => {
						if (2 & i && !(2 & n) && 2 != (2097155 & e.flags)) throw new S.ErrnoError(2)
						...
						;(h.onupgradeneeded = d),
							(h.onsuccess = () => {
								...
								o.forEach(e => {
									var t = r.get(e)
									;(t.onsuccess = () => {
										S.analyzePath(e).exists && S.unlink(e),
											S.createDataFile(v.dirname(e), v.basename(e), t.result, !0, !0, !0),
											++i + n == s && a()
									}),
										(t.onerror = () => {
											i + ++n == s && a()
			...
			function ye(e) {
				var t
				return void 0 === e ? '_unknown' : 48 <= (t = (e = e.replace(/[^a-zA-Z0-9_]/g, '$')).charCodeAt(0)) && t <= 57 ? '_' + e : e
			}
			function be(e, t) {
			...
			function Ne(e, t) {
				...
				t.$$ || k('Cannot pass "' + tt(t) + '" as a ' + this.name), t.$$.ptr || k('Cannot pass deleted object as a pointer of type ' + this.name)
			...
			function Oe(e, t) {
				...
				t.$$ || k('Cannot pass "' + tt(t) + '" as a ' + this.name),
			...
			function Xe(e, t) {
				...
				if (e instanceof Function)
					return (
						((r = be(e.name || 'unknownFunctionName', function () {})).prototype = e.prototype),
						(r = new r()),
			...
			function Ze(e, t, r, i, n) {
				...
				if (
					((u +=
						(l ? 'var rv = ' : '') +
						'invoker(fn' +
						(0 < (h = r ? 'thisWired' + (0 < h.length ? ', ' : '') + h : h).length ? ', ' : '') +
						h +
						');\n'),
					a)
				)
			...
			function Qe(e) {
				4 < e && 0 == --P[e].refcount && ((P[e] = void 0), Je.push(e))
			}
			var et = {
				...
				toHandle: e => {
					switch (e) {
						...
						case !1:
							return 4
						default:
							var t = Je.length ? Je.pop() : P.length
			...
			function tt(e) {
				var t
				return null === e ? 'null' : 'object' == (t = typeof e) || 'array' == t || 'function' == t ? e.toString() : '' + e
			}
			var rt = 'undefined' != typeof TextDecoder ? new TextDecoder('utf-16le') : void 0
			function it(e, t) {
				for (var r, i = e >> 1, n = i + t / 2; !(n <= i) && K[i]; ) ++i
				if (32 < (r = i << 1) - e && rt) return rt.decode(f.subarray(e, r))
			...
			Object.defineProperties(ct.prototype, {
				...
				(S.FSNode = ct),
				S.staticInit()
			for (var mt = new Array(256), _t = 0; _t < 256; ++_t) mt[_t] = String.fromCharCode(_t)
			;(_e = mt),
				...
				(I.prototype.fromWireType = function (e) {
					var t,
						...
						i = this.getPointee(e)
					return i
						? void 0 !== (t = De(this.registeredClass, i))
							? 0 === t.$$.count.value
							...
							: ((t = this.registeredClass.getActualType(i)),
								...
								null ===
									(r = (function e(t, r, i) {
										return r === i ? t : void 0 === i.baseClass || null === (t = e(t, r, i.baseClass)) ? null : i.downcast(t)
									})(i, this.registeredClass, t.registeredClass)))
									? n.call(this)
									: this.isSmartPointer
										? Pe(t.registeredClass.instancePrototype, { ptrType: t, ptr: r, smartPtrType: this, smartPtr: e })
										: Pe(t.registeredClass.instancePrototype, { ptrType: t, ptr: r }))
						: (this.destructor(e), null)
					function n() {
						return this.isSmartPointer
							? Pe(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: i, smartPtrType: this, smartPtr: e })
							: Pe(this.registeredClass.instancePrototype, { ptrType: this, ptr: e })
					}
				}),
				(je = _.UnboundTypeError = ve(Error, 'UnboundTypeError')),
			...
			var gt = {
					...
					m: function (l, e, t, d, r, h, i, u, n, f, p, s, c) {
								...
								if (d)
									for (var n = i, s = 0; s <= r; ++s) {
										var a,
											o = i + s
										;(s != r && 0 != f[o]) ||
											((a = ee(n, o - n)), void 0 === t ? (t = a) : (t = t + String.fromCharCode(0) + a), (n = o + 1))
									}
								else {
					...
					k: function (e, l, n) {
						...
						;(n = x(n)),
							2 === l
								? ((d = it), (s = nt), (a = st), (h = () => K), (u = 1))
								: 4 === l && ((d = at), (s = ot), (a = lt), (h = () => p), (u = 2)),
							C(e, {
								name: n,
								fromWireType: function (e) {
									for (var t, r = p[e >> 2], i = h(), n = e + 4, s = 0; s <= r; ++s) {
										var a,
											o = e + 4 + s * l
										;(s != r && 0 != i[o >> u]) ||
											((a = d(n, o - n)), void 0 === t ? (t = a) : (t = t + String.fromCharCode(0) + a), (n = o + l))
									}
									return L(e), t
								},
								toWireType: function (e, t) {
					...
					g: function (e, t, r, i) {
						;(e = ht[e])((t = et.toValue(t)), (r = void 0 === (t = dt[(e = r)]) ? x(e) : t), null, i)
					},
					e: Qe,
					f: function (e, t) {
						var r = ((e, t) => {
								for (var r, i, n = new Array(e), s = 0; s < e; ++s)
									n[s] = ((r = p[(t + 4 * s) >> 2]), void 0 === (i = A[r]) && k('parameter ' + s + ' has unknown type ' + We(r)), i)
								return n
							})(e, t),
							t = r[0],
							i =
					...
					x: function (a, o) {
						...
						return (
							pt().forEach(function (e, t) {
								for (var r = o + l, i = ((p[(a + 4 * t) >> 2] = r), e), n = r, s = 0; s < i.length; ++s) u[0 | n++] = i.charCodeAt(s)
								;(u[0 | n] = 0), (l += e.length + 1)
							}),
							0
						)
					},
					...
					t: function (e, t, r, i, n) {
						try {
							var s,
								a = (r + 2097152) >>> 0 < 4194305 - !!t ? (t >>> 0) + 4294967296 * r : NaN
							return isNaN(a)
								? 61
								: ((s = U.getStreamFromFD(e)),
									S.llseek(s, a, i),
									(y = [
										s.position >>> 0,
										((g = s.position),
				...
				yt = (_._malloc = function () {
					return (yt = _._malloc = _.asm.I).apply(null, arguments)
				}),
				bt = (_.___errno_location = function () {
					return (bt = _.___errno_location = _.asm.K).apply(null, arguments)
				}),
			...
			var wt,
				Et = (_._emscripten_builtin_memalign = function () {
					return (Et = _._emscripten_builtin_memalign = _.asm.N).apply(null, arguments)
				}),
			...
			function Ut() {
				...
				0 < r ||
					((() => {
						if (_.preRun) for ('function' == typeof _.preRun && (_.preRun = [_.preRun]); _.preRun.length; ) (e = _.preRun.shift()), ie.unshift(e)
						var e
						ue(ie)
					})(),
					0 < r) ||
			...
			if (
				...
				(_._ff_h264_cabac_tables = 215420),
				(i = function e() {
					wt || Ut(), wt || (i = e)
				}),
				_.preInit)
	...
	var X = (g, e) => {
		...
		function a(e, t) {
			...
			;(i = t),
				...
				(_ = s[1]),
				(s = s[2]),
				Math.abs(u - m) < S && Math.abs(f - _) < S && Math.abs(n - s) < S
					? B(i)
					: ((m = u - m),
						(_ = f - _),
						(s = n - s),
						(o = c * (s *= h = 1 / Math.hypot(m, _, s)) - a * (_ *= h)),
						(a = a * (m *= h) - p * s),
						(p = p * _ - c * m),
						...
						(l = s * o - m * p),
						(d = m * a - _ * o),
						(h = Math.hypot(c, l, d)) ? ((c *= h = 1 / h), (l *= h), (d *= h)) : (d = l = c = 0),
						(i[0] = o),
						(i[1] = c),
						(i[2] = m),
						(i[3] = 0),
						...
						(i[15] = 1))
			{
				...
				g.bindBuffer(g.ARRAY_BUFFER, b.position),
					g.vertexAttribPointer(y.attribLocations.vertexPosition, 3, e, !1, 0, 0),
					g.enableVertexAttribArray(y.attribLocations.vertexPosition)
			}
			{
				let e = g.FLOAT
				g.bindBuffer(g.ARRAY_BUFFER, b.texPosition),
					g.vertexAttribPointer(y.attribLocations.texturePosition, 2, e, !1, 0, 0),
			...
			{
				let e = g.UNSIGNED_SHORT
				g.drawElements(g.TRIANGLES, 6, e, 0)
			}
		}
		return {
	...
	let Z = 'fetch',
		...
		i = ''
	try {
		i = (i = document.currentScript.src).substring(0, i.lastIndexOf('/') + 1)
	} catch (g) {}
	let J = {
			playType: L,
			container: '',
			...
			loadingBackground: '',
			decoder: i + 'decoder-pro.js',
			decoderAudio: i + 'decoder-pro-audio.js',
			decoderWASM: '',
			isDecoderUseCDN: !1,
			url: '',
			rotate: 0,
	...
	let pe = [96e3, 88200, 64e3, 48e3, 44100, 32e3, 24e3, 22050, 16e3, 12e3, 11025, 8e3, 7350]
	function ce() {
	...
	try {
		if ('object' == typeof WebAssembly && 'function' == typeof WebAssembly.instantiate) {
			var k = new WebAssembly.Module(Uint8Array.of(0, 97, 115, 109, 1, 0, 0, 0))
			if (k instanceof WebAssembly.Module) new WebAssembly.Instance(k) instanceof WebAssembly.Instance
		}
	} catch (e) {}
	let C = Symbol(32),
		F = Symbol(16),
	...
	class W {
		...
		flush() {
			if (this.buffer && this.need) {
				let e = null,
					t = this.buffer.subarray(this.consumed),
					r = 0
				var i = e => t.length < (r = e)
	...
	class ye {
		constructor(i) {
			;(this.log = (e, ...t) => {
				...
				i._opt.debug &&
					i._opt.debugLevel == v &&
					((r = i._opt.debugUuid ? `[${i._opt.debugUuid}]` : ''), console.log(`JnWebPlayer${r}:[✅✅✅][${e}]`, ...t))
			}),
				(this.warn = (e, ...t) => {
					var r
					!i._opt.debug ||
						(i._opt.debugLevel != v && i._opt.debugLevel != w) ||
						((r = i._opt.debugUuid ? `[${i._opt.debugUuid}]` : ''), console.log(`JnWebPlayer${r}:[❗❗❗][${e}]`, ...t))
				}),
				(this.error = (e, ...t) => {
					var r = i._opt.debugUuid ? `[${i._opt.debugUuid}]` : ''
					console.error(`JnWebPlayer${r}:[❌❌❌][${e}]`, ...t)
				})
		}
	}
	class Y {
		...
		_fillCurrentWord() {
			...
			t <= 0
				...
				: ((t = Math.min(4, t)),
					(e = new Uint8Array(4)).set(this._buffer.subarray(this._buffer_index, this._buffer_index + t)),
		...
		readBits(e) {
			...
			return (
				...
				e <= this._current_word_bits_left
					? ((t = this._current_word >>> (32 - e)), (this._current_word <<= e), (this._current_word_bits_left -= e), t)
		...
		_skipLeadingZero() {
			...
			for (e = 0; e < this._current_word_bits_left; e++)
				if (this._current_word & (2147483648 >>> e)) return (this._current_word <<= e), (this._current_word_bits_left -= e), e
			...
			let p = 0,
				...
				S =
					(r.readBool() &&
						...
						r.readBool()) &&
						((A = r.readBits(32)), (B = r.readBits(32)), (v = r.readBool()), (w = B), (E = 2 * A), (b = w / E)),
					1),
				U = ((1 === g && 1 === y) || (S = g / y), 0),
				x = 0
			...
			let y = 0,
				...
				T =
					(n.readBool() &&
						...
						n.readBool()) &&
						((I = n.readBits(32)), (F = n.readBits(32)), (x = n.readBool()), (B = F), (A = 2 * I), (U = B / A)),
					1),
				k = ((1 === E && 1 === S) || (T = E / S), 0),
				C = 0
	...
	function be(t) {
			...
			if (((o += 2), 0 !== l)) {
				...
				if (0 === e) {
					...
					var l = n.frameRate.fps_den,
						h = n.frameRate.fps_num
					n.refSampleDuration = n.timescale * (l / h)
		...
		for (let e = 0; e < u; e++) {
			var f,
				p = r.getUint16(o, !1)
			;(o += 2), 0 !== p && ((f = new Uint8Array(t.buffer, o, p)), (o += p), (n.pps = f))
		}
		if (((n.videoType = 'avc'), n.sps)) {
			let e = n.sps.byteLength,
				t = new Uint8Array([(e >>> 24) & 255, (e >>> 16) & 255, (e >>> 8) & 255, 255 & e]),
				r = new Uint8Array(e + 4)
			r.set(t, 0), r.set(n.sps, 4), (n.sps = r)
		}
		if (n.pps) {
			let e = n.pps.byteLength,
				t = new Uint8Array([(e >>> 24) & 255, (e >>> 16) & 255, (e >>> 8) & 255, 255 & e]),
				r = new Uint8Array(e + 4)
			r.set(t, 0), r.set(n.pps, 4), (n.pps = r)
		}
		return n
	}
	function ve(e, t) {
	...
	function Ae(e) {
		...
		return (
			...
			(t.sps_temporal_id_nesting_flag = e.read(1)),
			(t.profile_tier_level = ((t, r) => {
				var i = {}
			...
			(t.sps_seq_parameter_set_id = e.read_golomb()),
			(t.chroma_format_idc = e.read_golomb()),
			(t.separate_colour_plane_flag = 3 == t.chroma_format_idc ? e.read(1) : 0),
			(t.pic_width_in_luma_samples = e.read_golomb()),
			(t.pic_height_in_luma_samples = e.read_golomb()),
			(t.conformance_window_flag = e.read(1)),
			t.conformance_window_flag
				? ((s = 1 + (t.chroma_format_idc < 2)),
					(a = 1 + (t.chroma_format_idc < 3)),
					(t.conf_win_left_offset = e.read_golomb() * a),
					(t.conf_win_right_offset = e.read_golomb() * a),
					(t.conf_win_top_offset = e.read_golomb() * s),
					(t.conf_win_bottom_offset = e.read_golomb() * s))
	...
	function Ce(e) {
		if (ke(e.length)) {
			for (var t = 0; t < e.length; t++) if (!ke(e[t]) || e[t] < 0 || 255 < e[t]) return
			return 1
		}
	}
	function s(e, t) {
		...
		if (Array.isArray(e)) {
			if (Ce(e)) return new Uint8Array(e)
			throw new Error('Array contains invalid value: ' + e)
		}
		if (ke(e.length) && Ce(e)) return new Uint8Array(e)
			...
			((Fe = '0123456789abcdef'),
			{
				...
				fromBytes: function (e) {
					for (var t = [], r = 0; r < e.length; r++) {
						var i = e[r]
						t.push(Fe[(240 & i) >> 4] + Fe[15 & i])
					}
					return t.join('')
				},
			}),
		Ie = { 16: 10, 24: 12, 32: 14 },
	...
	function h(e) {
		...
		;(this.description = 'Electronic Code Block'), (this.name = 'ecb'), (this._aes = new o(e))
	}
	function f(e, t) {
		...
		;(this._lastCipherblock = s(t, !0)), (this._aes = new o(e))
	}
	function p(e, t, r) {
		...
		;(this.segmentSize = r = r || 1), (this._shiftRegister = s(t, !0)), (this._aes = new o(e))
	}
	function c(e, t) {
		...
		;(this._lastPrecipher = s(t, !0)), (this._lastPrecipherIndex = 16), (this._aes = new o(e))
	}
	function m(e) {
		if (!(this instanceof m)) throw Error('Counter must be instanitated with `new`')
		'number' == typeof (e = 0 !== e ? e || 1 : e) ? ((this._counter = l(16)), this.setValue(e)) : this.setBytes(e)
	}
	function _(e, t) {
	...
	;(o.prototype._prepare = function () {
		var e = Ie[this.key.length]
		if (null == e) throw new Error('invalid key size (must be 16, 24 or 32 bytes)')
		;(this._Ke = []), (this._Kd = [])
		for (var t = 0; t <= e; t++) this._Ke.push([0, 0, 0, 0]), this._Kd.push([0, 0, 0, 0])
		for (var r, i = 4 * (e + 1), n = this.key.length / 4, s = We(this.key), t = 0; t < n; t++)
			(this._Ke[(r = t >> 2)][t % 4] = s[t]), (this._Kd[e - r][t % 4] = s[t])
		for (var a, o = 0, l = n; l < i; ) {
			if (
				((a = s[n - 1]),
				(s[0] ^= (u[(a >> 16) & 255] << 24) ^ (u[(a >> 8) & 255] << 16) ^ (u[255 & a] << 8) ^ u[(a >> 24) & 255] ^ (De[o] << 24)),
				(o += 1),
				8 != n)
			)
		...
		for (var d = 1; d < e; d++)
			for (var h = 0; h < 4; h++) (a = this._Kd[d][h]), (this._Kd[d][h] = He[(a >> 24) & 255] ^ Ve[(a >> 16) & 255] ^ $e[(a >> 8) & 255] ^ je[255 & a])
	}),
		(o.prototype.encrypt = function (e) {
			if (16 != e.length) throw new Error('invalid plaintext size (must be 16 bytes)')
			for (var t = this._Ke.length - 1, r = [0, 0, 0, 0], i = We(e), n = 0; n < 4; n++) i[n] ^= this._Ke[0][n]
			for (var s = 1; s < t; s++) {
				for (n = 0; n < 4; n++)
					r[n] =
						Pe[(i[n] >> 24) & 255] ^ Le[(i[(n + 1) % 4] >> 16) & 255] ^ ze[(i[(n + 2) % 4] >> 8) & 255] ^ Re[255 & i[(n + 3) % 4]] ^ this._Ke[s][n]
				i = r.slice()
			}
		...
		(o.prototype.decrypt = function (e) {
			...
			for (var t = this._Kd.length - 1, r = [0, 0, 0, 0], i = We(e), n = 0; n < 4; n++) i[n] ^= this._Kd[0][n]
			for (var s = 1; s < t; s++) {
				for (n = 0; n < 4; n++)
					r[n] =
						Me[(i[n] >> 24) & 255] ^ Ne[(i[(n + 3) % 4] >> 16) & 255] ^ Oe[(i[(n + 2) % 4] >> 8) & 255] ^ Ge[255 & i[(n + 1) % 4]] ^ this._Kd[s][n]
				i = r.slice()
			}
			for (var a, o = l(16), n = 0; n < 4; n++)
				(a = this._Kd[t][n]),
	...
	let Ye = {
		AES: o,
		Counter: m,
		ModeOfOperation: { ecb: h, cbc: f, cfb: p, ofb: c, ctr: _ },
		utils: { hex: e, utf8: y },
		padding: {
			pkcs7: {
				pad: function (e) {
	...
	var K = r(function (e, t) {
		...
		function i() {
			var n = [, , , 'ES_Descriptor', 'DecoderConfigDescriptor', 'DecoderSpecificInfo', 'SLConfigDescriptor'],
				i =
				...
				(this.parseOneDescriptor = function (e) {
					...
					return (
						f.debug(
							...
							'Found ' + (n[r] || 'Descriptor ' + r) + ', size ' + (t += 127 & i) + ' at position ' + e.getPosition(),
						),
		...
		var a,
			...
			b =
				...
				(l.prototype.writeStruct = function (e, t) {
					for (var r = 0; r < e.length; r += 2) this.writeType(e[r + 1], t[e[r]], t)
				}),
				(l.prototype.writeType = function (e, t, r) {
					...
					switch (
						...
						case 'u16stringbe':
							...
							break
						default:
							if (3 == e.length) for (var a = e[1], o = 0; o < t.length; o++) this.writeType(a, t[o])
		...
		b.initialize(),
								...
								: (b[l + 'Box']
										...
										: 'uuid' !== l
											...
											: b.UUIDBoxes[n]
												...
												: (f.warn('BoxParser', "Unknown uuid type: '" + n + "'"),
													((i = new b.Box(l, o)).uuid = n),
									...
									(r = e.getPosition() - (i.start + i.size)) < 0
										...
										: 0 < r &&
											(f.error(
												'BoxParser',
												"Parsing of box '" + d + "' read " + r + ' more bytes than the indicated box data size, seeking backwards',
											),
											0 !== i.size) &&
											e.seek(i.start + i.size),
									{ code: b.OK, box: i, size: i.size })
			...
			(b.ContainerBox.prototype.parse = function (e) {
				for (var t, r; e.getPosition() < this.start + this.size; ) {
					...
					this.boxes.push((t = t.box)),
						this.subBoxNames && -1 != this.subBoxNames.indexOf(t.type)
							? this[this.subBoxNames[this.subBoxNames.indexOf(t.type)] + 's'].push(t)
							: this[(r = 'uuid' !== t.type ? t.type : t.uuid)]
								? f.warn('Box of type ' + r + ' already stored in field of this type')
								: (this[r] = t)
				}
			}),
			...
			b.createFullBoxCtor('iloc', function (e) {
				...
				for (var i = 0; i < r; i++) {
					var n = {}
					if ((this.items.push(n), !(this.version < 2) && 2 !== this.version)) throw 'version of iloc box not supported'
					switch (
			...
			b.createFullBoxCtor('infe', function (e) {
				;(0 !== this.version && 1 !== this.version) ||
					...
					1 === this.version
						? ((this.extension_type = e.readString(4)), f.warn('BoxParser', 'Cannot parse extension type'), e.seek(this.start + this.size))
						: 2 <= this.version &&
			...
			b.createFullBoxCtor('stvi', function (e) {
				...
				for (this.stereo_indication_type = e.readString(t), this.boxes = []; e.getPosition() < this.start + this.size; ) {
					...
					this.boxes.push((r = r.box)), (this[r.type] = r)
				}
			}),
			...
			(b.hev1SampleEntry.prototype.getCodec = b.hvc1SampleEntry.prototype.getCodec =
				function () {
					var e = b.SampleEntry.prototype.getCodec.call(this)
					if (this.hvcC) {
			...
			(b.vvc1SampleEntry.prototype.getCodec = b.vvi1SampleEntry.prototype.getCodec =
				function () {
					var e = b.SampleEntry.prototype.getCodec.call(this)
					if (this.vvcC) {
						...
						if (this.vvcC.general_constraint_info) {
							...
							for (l = 0; l < this.vvcC.general_constraint_info.length; ++l)
								(n |= (this.vvcC.general_constraint_info[l] >> 2) & 63),
									i.push(n),
									n && (r = l),
									(n = (this.vvcC.general_constraint_info[l] >> 2) & 3)
							if (void 0 === r) t = '.CA'
							else {
			...
			(b.vp08SampleEntry.prototype.getCodec = b.vp09SampleEntry.prototype.getCodec =
				function () {
					var e = b.SampleEntry.prototype.getCodec.call(this),
						t = this.vpcC.level,
		...
		;(B.prototype.setSegmentOptions = function (e, t, r) {
			...
			(B.prototype.setExtractionOptions = function (e, t, r) {
				var i,
					n = this.getTrackById(e)
				n &&
					(this.extractedTracks.push((i = {})), (i.id = e), (i.user = t), ((i.trak = n).nextSample = 0), (i.nb_samples = 1e3), (i.samples = []), r) &&
					r.nbSamples &&
			...
			(B.prototype.appendBuffer = function (e, t) {
				...
				if (this.checkBuffer(e))
					return (
						...
						this.meta &&
							(this.flattenItemInfo && !this.itemListBuilt && (this.flattenItemInfo(), (this.itemListBuilt = !0)), this.processItems) &&
							...
							for (var r = this.fragmentedTracks[t], i = r.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted; ) {
								...
								if (
									...
									(i.nextSample % r.nb_samples == 0 || e || i.nextSample >= i.samples.length) &&
										...
										f.info('ISOFile', 'Sample data size in memory: ' + this.getAllocatedSampleDataSize()),
										this.onSegment &&
											this.onSegment(r.id, r.user, r.segmentStream.buffer, i.nextSample, e || i.nextSample >= i.samples.length),
			...
			(B.prototype.addTrack = function (e) {
				...
				if (void 0 !== b[t.type + 'SampleEntry']) {
					...
					return (
						...
						r.add('stsc').set('first_chunk', []).set('samples_per_chunk', []).set('sample_description_index', []),
			...
			(B.prototype.createSingleSampleMoof = function (e) {
				...
				return (
					i.add('tfhd').set('track_id', e.track_id).set('flags', b.TFHD_FLAG_DEFAULT_BASE_IS_MOOF),
				...
				for (n in ((t.sample_groups = []), i))
					(t.sample_groups[n] = {}),
						...
						r >= i[n].last_sample_in_run &&
							...
							(i[n].last_sample_in_run += i[n].sbgp.entries[i[n].entry_index].sample_count),
						i[n].entry_index <= i[n].sbgp.entries.length - 1
					...
					for (t = 0; t < n.sample_sizes.length; t++) {
						...
						;(x.number = t),
							...
							0 < t
								...
								: (x.dts = 0),
							a
								? (v <= t && (w++, v < 0 && (v = 0), (v += a.sample_counts[w])), (x.cts = e.samples[t].dts + a.sample_offsets[w]))
								: (x.cts = x.dts),
							o
								? (t == o.sample_numbers[E] - 1 ? ((x.is_sync = !0), E++) : ((x.is_sync = !1), (x.degradation_priority = 0)),
									d &&
										d.entries[S].sample_delta + U == t + 1 &&
										((x.subsamples = d.entries[S].subsamples), (U += d.entries[S].sample_delta), S++))
								: (x.is_sync = !0),
						...
						for (l = 0; l < t.iloc.items.length; l++) {
							...
							switch (
								(0 !== r.data_reference_index &&
									(f.warn('Item storage with reference to other files: not supported'),
			...
			(B.prototype.itemToFragmentedTrackFile = function (e) {
				var t,
					r,
					e = e || {}
				return null != (e = e.itemId ? this.getItem(e.itemId) : this.getPrimaryItem()) &&
			...
			if ((this.s || !(50 < this.l)) && (this.l++, !this.d)) {
				...
				if (this.A) {
					...
					var r = ((t, e) => {
						...
						if (r) {
							let e = qe(t.slice(r + 16, r + 16 + 8))
							return [e, qe(t.slice(r + 24, r + 24 + 8)), t.slice(r + 32, r + 32 + e).map(e => ~e)]
						}
						return null
					})(t, this.t)
					if (!r) return e
					...
					;(this.A = !0),
						...
						WebAssembly.instantiate(r[2], i)
							.then(e => {
								var t
								'function' != typeof (t = e.instance.exports).parse || 'object' != typeof t.memory
	...
	function Ze(l) {
		...
		let s = [],
			...
			k =
				('VideoEncoder' in self &&
					(a = {
						...
						decoder: new VideoDecoder({
							output: function (t) {
								...
								a.isEmitInfo ||
									...
									postMessage({ cmd: Q, w: t.codedWidth, h: t.codedHeight }),
									(a.isEmitInfo = !0),
									...
									'function' == typeof t.createImageBitmap
										? t.createImageBitmap().then(e => {
												...
												postMessage({ cmd: R, buffer: e, delay: I.delay, ts: 0 }, [e]),
													setTimeout(function () {
						...
						decode: function (r, t, e) {
							var i = r[0] >> 4 == 1
							if (a.hasInit) {
								let e = new EncodedVideoChunk({ data: r.slice(5), timestamp: t, type: i ? 'key' : 'delta' })
								a.decoder.decode(e)
							} else if (i && 0 === r[1]) {
								let e = 15 & r[0],
									t =
										(postMessage({ cmd: te, code: e }),
										(e => {
											let r = e.subarray(1, 4),
												i = 'avc1.'
											for (let t = 0; t < 3; t++) {
								...
								postMessage({ cmd: re, buffer: r, codecId: e }, [r.buffer]), a.decoder.configure(t), (a.hasInit = !0)
							}
						},
						reset() {
							;(a.hasInit = !1), (a.isEmitInfo = !1), (a.offscreenCanvas = null), (a.offscreenCanvasCtx = null)
						},
					}),
				{
					init() {
						;(k.lastBuf = null), (k.vps = null), (k.sps = null), (k.pps = null), (k.streamType = null), (k.localDts = 0), (k.isSendSeqHeader = !1)
					},
					destroy() {
						;(k.lastBuf = null), (k.vps = null), (k.sps = null), (k.pps = null), (k.streamType = null), (k.localDts = 0), (k.isSendSeqHeader = !1)
					},
					...
					getNaluDts() {
						var e = k.localDts
						return (k.localDts = k.localDts + 40), e
					},
					getNaluAudioDts() {
						var e = I._opt.sampleRate,
							t = I._opt.audioBufferSize
						return k.localDts + parseInt((t / e) * 1e3)
					},
					extractNALu(e) {
						let t,
							r,
					...
					extractNALu$2(t) {
						...
						if (t && !(t.byteLength < 1)) {
							k.lastBuf
								? ((s = new Uint8Array(t.byteLength + k.lastBuf.length)).set(k.lastBuf), s.set(new Uint8Array(t), k.lastBuf.length))
								: (s = new Uint8Array(t))
							let r = 0,
								i = -1,
								n = -2
							...
							for (let r = 0; r < s.length; r += 2) {
								let e = s[r],
									t = s[r + 1]
								0 == i && 0 == e && 0 == t ? a.push(r - 1) : 1 == t && 0 == e && 0 == i && 0 == n && a.push(r - 2), (n = e), (i = t)
							}
							if (1 < a.length)
								for (let t = 0; t < a.length - 1; ++t) {
									let e = s.subarray(a[t], a[t + 1] + 1)
									k.handleNALu(e), (r = a[t + 1])
								}
							else r = a[0]
							if (0 != r && r < s.length) k.lastBuf = s.subarray(r)
							else {
								k.lastBuf || (k.lastBuf = s)
								let e = new Uint8Array(k.lastBuf.length + t.byteLength)
								e.set(k.lastBuf), e.set(new Uint8Array(t), k.lastBuf.length), (k.lastBuf = e)
							}
						}
					},
					handleNALu(e) {
						e.byteLength <= 4
							? I.debug.warn('worker', `handleNALu nalu byteLength is ${e.byteLength} <= 4`)
							: ((e = e.slice(4)), k.handleVideoNalu(e))
					},
					handleVideoNalu(e) {
						if (
							(k.streamType ||
								(k.streamType = (e => {
									let t = null,
										r = 31 & e[0]
									return (t = (t = r !== H && r !== V ? t : ae) || ((r = (126 & e[0]) >> 1) !== le && r !== de && r !== $) ? t : oe)
								})(e)),
							k.streamType === ae)
						) {
							var t = k.handleAddNaluStartCode(e),
								t = k.extractNALu(t)
							if (0 === t.length) I.debug.warn('worker', 'handleVideoNalu', 'naluList.length === 0')
							else {
								let r = []
								if (
									(t.forEach(e => {
										var t = q(e)
										t === V || t === H ? k.handleVideoH264Nalu(e) : Se(t) && r.push(e)
									}),
									1 === r.length)
								)
									k.handleVideoH264Nalu(r[0])
								else {
									let e = (t => {
										if (0 === t.length) return !1
										var r = q(t[0])
										for (let e = 1; e < t.length; e++) if (r !== q(t[e])) return !1
										return !0
									})(r)
									if (e) {
										let e = q(r[0]),
											t = Ue(e)
										k.handleVideoH264NaluList(r, t, e)
									} else
										r.forEach(e => {
											k.handleVideoH264Nalu(e)
										})
								}
							}
						} else k.streamType === oe && (Te(e) === $ ? k.extractH265PPS(e) : k.handleVideoH265Nalu(e))
					},
					extractH264PPS(e) {
						e = k.handleAddNaluStartCode(e)
						k.extractNALu(e).forEach(e => {
							Ee(q(e)) ? k.extractH264SEI(e) : k.handleVideoH264Nalu(e)
						})
					},
					extractH265PPS(e) {
						e = k.handleAddNaluStartCode(e)
						k.extractNALu(e).forEach(e => {
							39 === Te(e) ? k.extractH265SEI(e) : k.handleVideoH265Nalu(e)
						})
					},
					extractH264SEI(e) {
						e = k.handleAddNaluStartCode(e)
					...
					handleVideoH264Nalu(e) {
						...
						if (k.isSendSeqHeader)
							Se(a)
								? ((t = Ue(a)),
									(r = k.getNaluDts()),
									t && I.calcIframeIntervalTimestamp(r),
									I.calcNetworkDelay(r),
									(i = e),
									((n = [])[0] = t ? 23 : 39),
									(n[1] = 1),
									(n[2] = 0),
									(n[3] = 0),
									(n[4] = 0),
									(n[5] = (i.byteLength >> 24) & 255),
									(n[6] = (i.byteLength >> 16) & 255),
									(n[7] = (i.byteLength >> 8) & 255),
									(n[8] = 255 & i.byteLength),
									(s = new Uint8Array(n.length + i.byteLength)).set(n, 0),
									s.set(i, n.length),
									(i = s),
									I.decode(i, { type: 2, ts: r, isIFrame: t, cts: 0 }))
								: I.debug.warn('work', 'handleVideoH264Nalu Avc Seq Head is ' + a)
						else if (k.sps && k.pps) {
							k.isSendSeqHeader = !0
							;({ sps: n, pps: s } = [{ sps: k.sps, pps: k.pps }][0]),
								((i = [23, 0, 0, 0, 0, 1, 66, 0, 30, 255])[6] = n[1]),
								(i[7] = n[2]),
								(i[8] = n[3]),
								(i[10] = 225),
								(i[11] = (n.byteLength >> 8) & 255),
								(i[12] = 255 & n.byteLength),
								i.push(...n, 1, (s.byteLength >> 8) & 255, 255 & s.byteLength, ...s)
					...
					handleVideoH265Nalu(e) {
						...
						if (k.isSendSeqHeader)
							32 <= o && o <= 40
								? I.debug.warn('work', 'handleVideoH265Nalu HevcSeqHead is ' + o)
								: ((o = 16 <= o && o <= 21),
									(t = k.getNaluDts()),
									I.calcNetworkDelay(t),
									(n = e),
									((s = [])[0] = o ? 28 : 44),
									(s[1] = 1),
									(s[2] = 0),
									(s[3] = 0),
									(s[4] = 0),
									(s[5] = (n.byteLength >> 24) & 255),
									(s[6] = (n.byteLength >> 16) & 255),
									(s[7] = (n.byteLength >> 8) & 255),
									(s[8] = 255 & n.byteLength),
									(a = new Uint8Array(s.length + n.byteLength)).set(s, 0),
									a.set(n, s.length),
									(n = a),
									o && I.calcIframeIntervalTimestamp(t),
									I.decode(n, { type: 2, ts: t, isIFrame: o, cts: 0 }))
						else if (k.vps && k.sps && k.pps) {
							k.isSendSeqHeader = !0
							;({ vps: s, pps: a, sps: n } = [{ vps: k.vps, sps: k.sps, pps: k.pps }][0]),
								(t = { configurationVersion: 1 }),
								(o = (e => {
									;(e = xe(e)), (e = new Y(e))
									return (
										e.readByte(),
										...
										e.readBits(2),
										e.readBits(6),
										{ num_temporal_layers: e.readBits(3) + 1, temporal_id_nested: e.readBool() }
									)
								})(s)),
								(r = (e => {
									let t = xe(e),
									...
									var o = s.readBits(3),
										...
										y = [],
										N = []
									for (let e = 0; e < o; e++) y.push(s.readBool()), N.push(s.readBool())
									...
									if ((s.readBool(), s.readBool(), s.readBool())) {
										if (
											(s.readBool() &&
												(0 < (b = s.readByte()) && b < 16
													? ((A = [1, 12, 10, 16, 40, 24, 20, 32, 80, 18, 15, 64, 160, 4, 3, 2][b - 1]),
														(T = [1, 11, 11, 11, 33, 11, 11, 11, 33, 11, 11, 33, 99, 3, 2, 1][b - 1]))
													: 255 === b && ((A = s.readBits(16)), (T = s.readBits(16)))),
										...
										s.readBool() &&
											(s.readBool(), s.readBool(), s.readBool(), (B = s.readUEG()), s.readUEG(), s.readUEG(), s.readUEG(), s.readUEG())
									}
									s.readBool()
								...
								(i = (e => {
									...
									let t = e.readBool(),
										r = e.readBool(),
										i = 1
									return r && t ? (i = 0) : r ? (i = 3) : t && (i = 2), { parallelismType: i }
								})(a)),
								(t = Object.assign(t, o, r, i)),
								(o = 23 + (5 + s.byteLength) + (5 + n.byteLength) + (5 + a.byteLength)),
								((r = new Uint8Array(o))[0] = 1),
								(r[1] = ((3 & t.general_profile_space) << 6) | ((t.general_tier_flag ? 1 : 0) << 5) | (31 & t.general_profile_idc)),
								(r[2] = t.general_profile_compatibility_flags_1 || 0),
								(r[3] = t.general_profile_compatibility_flags_2 || 0),
								(r[4] = t.general_profile_compatibility_flags_3 || 0),
								(r[5] = t.general_profile_compatibility_flags_4 || 0),
								(r[6] = t.general_constraint_indicator_flags_1 || 0),
								(r[7] = t.general_constraint_indicator_flags_2 || 0),
								(r[8] = t.general_constraint_indicator_flags_3 || 0),
								(r[9] = t.general_constraint_indicator_flags_4 || 0),
								(r[10] = t.general_constraint_indicator_flags_5 || 0),
								(r[11] = t.general_constraint_indicator_flags_6 || 0),
								(r[12] = 60),
								(r[13] = 240 | ((3840 & t.min_spatial_segmentation_idc) >> 8)),
								(r[14] = 255 & t.min_spatial_segmentation_idc),
								(r[15] = 252 | (3 & t.parallelismType)),
								(r[16] = 252 | (3 & t.chroma_format_idc)),
								(r[17] = 248 | (7 & t.bit_depth_luma_minus8)),
								(r[18] = 248 | (7 & t.bit_depth_chroma_minus8)),
								(r[19] = 0),
								(r[20] = 0),
								(r[21] = ((3 & t.constant_frame_rate) << 6) | ((7 & t.num_temporal_layers) << 3) | ((t.temporal_id_nested ? 1 : 0) << 2) | 3),
								(r[22] = 3),
								(r[23] = 128 | le),
								(r[24] = 0),
								(r[25] = 1),
								(r[26] = (65280 & s.byteLength) >> 8),
								(r[27] = 255 & s.byteLength),
								r.set(s, 28),
								(r[23 + (5 + s.byteLength) + 0] = 128 | de),
								(r[23 + (5 + s.byteLength) + 1] = 0),
								(r[23 + (5 + s.byteLength) + 2] = 1),
								(r[23 + (5 + s.byteLength) + 3] = (65280 & n.byteLength) >> 8),
								(r[23 + (5 + s.byteLength) + 4] = 255 & n.byteLength),
								r.set(n, 23 + (5 + s.byteLength) + 5),
								(r[23 + (5 + s.byteLength + 5 + n.byteLength) + 0] = 128 | $),
								(r[23 + (5 + s.byteLength + 5 + n.byteLength) + 1] = 0),
								(r[23 + (5 + s.byteLength + 5 + n.byteLength) + 2] = 1),
								(r[23 + (5 + s.byteLength + 5 + n.byteLength) + 3] = (65280 & a.byteLength) >> 8),
								(r[23 + (5 + s.byteLength + 5 + n.byteLength) + 4] = 255 & a.byteLength),
								r.set(a, 23 + (5 + s.byteLength + 5 + n.byteLength) + 5),
								(i = [28, 0, 0, 0, 0]),
								(o = new Uint8Array(i.length + r.byteLength)).set(i, 0),
								o.set(r, i.length)
							let e = o
							I.decode(e, { type: 2, ts: 0, isIFrame: !0, cts: 0 })
						}
			...
			C = {
				...
				isHevc: !1,
				listenMp4Box() {
					;(C.mp4Box.onReady = C.onReady), (C.mp4Box.onError = C.onError), (C.mp4Box.onSamples = C.onSamples)
				},
				initTransportDescarmber() {
					C.transportDescarmber = new Xe()
				},
				_getSeqHeader(e) {
					let t = C.mp4Box.getTrackById(e.id)
					for (let r of t.mdia.minf.stbl.stsd.entries)
						if (r.avcC || r.hvcC) {
							let e = new K.DataStream(void 0, 0, K.DataStream.BIG_ENDIAN),
								t = []
							t = r.avcC ? (r.avcC.write(e), [23, 0, 0, 0, 0]) : ((C.isHevc = !0), r.hvcC.write(e), [28, 0, 0, 0, 0])
							var i = new Uint8Array(e.buffer, 8),
								n = new Uint8Array(t.length + i.length)
							return n.set(t, 0), n.set(i, t.length), n
						}
					return null
				},
				onReady(e) {
					I.debug.log(C.LOG_NAME, 'onReady()', e)
					let t = e.videoTracks[0],
						i = e.audioTracks[0]
					if (t) {
						C.videoTrackId = t.id
						let e = C._getSeqHeader(t)
						e && (I.debug.log(C.LOG_NAME, 'seqHeader'), I.decodeVideo(e, 0, !0, 0)), C.mp4Box.setExtractionOptions(t.id)
					}
					if (i) {
						C.audioTrackId = i.id
						let e = i.audio || {},
							t = pe.indexOf(e.sample_rate),
							r = i.codec.replace('mp4a.40.', '')
						C.mp4Box.setExtractionOptions(i.id)
						;({ profile: n, sampleRate: s, channel: a } = [{ profile: parseInt(r, 10), sampleRate: t, channel: e.channel_count }][0])
						n = new Uint8Array([175, 0, (n << 3) | ((14 & s) >> 1), ((1 & s) << 7) | (a << 3)])
						I.debug.log(C.LOG_NAME, 'aacADTSHeader'), I.decodeAudio(n, 0)
					}
					var n, s, a
					C.mp4Box.start()
				},
				onError(e) {
					I.debug.error(C.LOG_NAME, 'mp4Box onError', e)
				},
				onSamples(e, t, n) {
					if (e === C.videoTrackId)
						for (let i of n) {
							let e = i.data,
								t = i.is_sync,
								r = (1e3 * i.cts) / i.timescale
							i, i, t && I.calcIframeIntervalTimestamp(r)
							s = C.isHevc
								? ((s = e),
									(a = t),
									void 0,
									...
									(o[3] = 0),
									(o[4] = 0),
									(a = new Uint8Array(o.length + s.byteLength)).set(o, 0),
									a.set(s, o.length),
									a)
								: ve(e, t)
							I.decode(s, { type: 2, ts: r, isIFrame: t, cts: 0 })
						}
					else if (e === C.audioTrackId)
						for (let r of n) {
							let e = r.data,
								t = (1e3 * r.cts) / r.timescale
							r, r
							var i = new Uint8Array(e.byteLength + 2)
							i.set([175, 1], 0), i.set(e, 2), I.decode(i, { type: 1, ts: t, isIFrame: !1, cts: 0 })
						}
					else I.debug.warn(C.LOG_NAME, 'onSamples() trackId error', e)
					var s, a, o
				},
				dispatch(e) {
					let t = e
					'string' != typeof e
						? 'object' == typeof e
							? (((t = C.transportDescarmber ? C.transportDescarmber.transport(t) : t).buffer.fileStart = C.offset),
								(C.offset += t.byteLength),
								C.mp4Box.appendBuffer(t.buffer))
							: I.debug.warn(C.LOG_NAME, 'dispatch()', 'data is not object', e)
						: I.debug.warn(C.LOG_NAME, 'dispatch()', 'data is string', e)
				},
				destroy() {
					C.mp4Box && (C.mp4Box.flush(), (C.mp4Box = null)),
						C.transportDescarmber && (C.transportDescarmber.destroy(), (C.transportDescarmber = null)),
						(C.offset = 0),
						(C.videoTrackId = null),
						(C.audioTrackId = null),
						(C.isHevc = !1)
			...
			F = {
				...
				destroy() {
					;(F.lastBuffer = new Uint8Array(0)),
						(F.parsedOffset = 0),
						(F.firstStartCodeOffset = 0),
						(F.secondStartCodeOffset = 0),
						(F.state = 'init'),
						(F.hasInitVideoCodec = !1),
						(F.localDts = 0)
				},
				extractNALu(e) {
					if (!e || e.byteLength < 1) I.debug.warn(F.LOG_NAME, 'extractNALu() buffer error', e)
					else {
						var t = new Uint8Array(F.lastBuffer.length + e.length)
						for (t.set(F.lastBuffer, 0), t.set(new Uint8Array(e), F.lastBuffer.length), F.lastBuffer = t; ; ) {
							if ('init' === F.state) {
								let e = !1
								for (; 4 <= F.lastBuffer.length - F.parsedOffset; ) {
									if (
										0 === F.lastBuffer[F.parsedOffset] &&
										0 === F.lastBuffer[F.parsedOffset + 1] &&
										1 === F.lastBuffer[F.parsedOffset + 2] &&
										182 === F.lastBuffer[F.parsedOffset + 3]
									) {
										;(F.state = 'findFirstStartCode'), (F.firstStartCodeOffset = F.parsedOffset), (F.parsedOffset += 4), (e = !0)
										break
									}
									F.parsedOffset++
								}
							...
							if ('findFirstStartCode' === F.state) {
								...
								for (; 4 <= F.lastBuffer.length - F.parsedOffset; ) {
									if (
										...
										;(F.state = 'findSecondStartCode'), (F.secondStartCodeOffset = F.parsedOffset), (F.parsedOffset += 4), (e = !0)
										break
									}
									F.parsedOffset++
								}
							...
							if ('findSecondStartCode' === F.state) {
								if (!(0 < F.lastBuffer.length - F.parsedOffset)) break
								{
									let e,
										t,
										r = 192 & F.lastBuffer[F.parsedOffset]
									e = 0 == r ? F.secondStartCodeOffset - 14 : F.secondStartCodeOffset
									var i = 0 == (192 & F.lastBuffer[F.firstStartCodeOffset + 4])
									if (i) {
										if (F.firstStartCodeOffset - 14 < 0)
											return void I.debug.warn(F.LOG_NAME, 'firstStartCodeOffset -14 is', F.firstStartCodeOffset - 14)
										F.hasInitVideoCodec || ((F.hasInitVideoCodec = !0), P.setCodec(99, '')),
											(t = F.lastBuffer.subarray(F.firstStartCodeOffset - 14, e))
									} else t = F.lastBuffer.subarray(F.firstStartCodeOffset, e)
									var n = F.getNaluDts()
									F.hasInitVideoCodec
										? (postMessage({ cmd: M, type: ie, value: t.byteLength }),
											postMessage({ cmd: M, type: ne, value: n }),
											P.decode(t, i ? 1 : 0, n))
										: I.debug.warn(F.LOG_NAME, 'has not init video codec'),
										(F.lastBuffer = F.lastBuffer.subarray(e)),
										(F.firstStartCodeOffset = 0 == r ? 14 : 0),
										(F.parsedOffset = F.firstStartCodeOffset + 4),
										(F.state = 'findFirstStartCode')
								}
							}
						}
					}
				...
				getNaluDts() {
					var e = F.localDts
					return (F.localDts = F.localDts + 40), e
				},
			},
			I = {
				isPlayer: !0,
					...
					I.stopStreamRateAndStatsInterval(),
						(e = setInterval(() => {
							...
							var e = JSON.stringify({
								...
								isDropping: ge(I.dropping) || ge(I.isPushDropping),
								isStreamTsMoreThanLocal: m,
							})
							postMessage({ cmd: M, type: 'streamStats', value: e })
						}, 1e3))
				},
				...
				getDelay: function (e) {
					var t, r
					return !e || (I._opt.hasVideo && !c)
						? -1
						: (I.preDelayTimestamp && I.preDelayTimestamp > e
								? 1e3 < I.preDelayTimestamp - e &&
									I.debug.warn(
										'worker',
										`getDelay() and preDelayTimestamp is ${I.preDelayTimestamp} > timestamp is ${e} more than ${I.preDelayTimestamp - e}ms`,
									)
								: I.firstTimestamp
									? e &&
										((t = Date.now() - I.startTimestamp),
										(r = e - I.firstTimestamp) <= t ? ((m = !1), (I.delay = t - r)) : ((m = !0), (I.delay = r - t)))
									: ((I.firstTimestamp = e), (I.startTimestamp = Date.now()), (I.delay = -1)),
							(I.preDelayTimestamp = e),
							I.delay)
				},
				getDelayNotUpdateDelay: function (t) {
					if (t && (!I._opt.hasVideo || c))
						if (I.preDelayTimestamp && 1e3 < I.preDelayTimestamp - t)
							I.debug.warn(
								'worker',
								`getDelayNotUpdateDelay and preDelayTimestamp is ${I.preDelayTimestamp} > timestamp is ${t} more than ${I.preDelayTimestamp - t}ms`,
							)
						else if (I.firstTimestamp) {
							let e = -1
							var r
							return (
								t && ((r = Date.now() - I.startTimestamp), (t = t - I.firstTimestamp), (e = t <= r ? ((m = !1), r - t) : ((m = !0), t - r))), e
							)
						}
					return -1
				},
				...
				doDecode: function (e) {
					I._opt.useWCS && I.useOffscreen() && 2 === e.type && a.decode
						? a.decode(e.payload, e.ts, e.cts)
						: e.decoder.decode(e.payload, e.ts, e.isIFrame, e.cts)
				},
				init: function () {
					I.debug.log('worker', 'init and opt is', I._opt)
					let e = I._opt.playType === L,
						t = 'playbackTF' === I._opt.playType
					if ((k.init(), (I.isPlayer = e), (I.isPlayback = t), I.isPlaybackCacheBeforeDecodeForFpsRender()))
						I.debug.log('worker', 'playback and playbackIsCacheBeforeDecodeForFpsRender is true')
					else {
						let t = () => {
							let t = null
							if (s.length)
								if (I.isPushDropping) I.debug.warn('worker', 'loop() isPushDropping is true and bufferList length is ' + s.length)
								else if (I.dropping) {
									for (
										t = s.shift(),
											I.debug.warn(
												'worker',
												`loop() dropBuffer is dropping and isIFrame ${t.isIFrame} and delay is ${I.delay} and bufferlist is ` +
													s.length,
											);
										!t.isIFrame && s.length;
										...
										t = s.shift()
									let e = I.getDelayNotUpdateDelay(t.ts)
									t.isIFrame &&
										e <= I.getNotDroppingDelayTs() &&
										(I.debug.log('worker', 'loop() is dropping = false, is iFrame'), (I.dropping = !1), I.doDecode(t))
								} else if (((t = s[0]), -1 === I.getDelay(t.ts) || I.isPlayback))
									I.isPlayer && I.debug.log('worker', 'loop() common dumex delay is -1 ,data.ts is', t.ts), s.shift(), I.doDecode(t)
								else if (I.delay > I._opt.videoBuffer + I._opt.videoBufferDelay && e)
									I.hasIframeInBufferList()
										? (I.debug.log('worker', `delay is ${I.delay}, set dropping is true`), I.resetAllDelay(), (I.dropping = !0))
										: (s.shift(), I.doDecode(t))
								else
									for (; s.length; ) {
										if (((t = s[0]), !(I.getDelay(t.ts) > I._opt.videoBuffer))) {
											I.delay < 0 && I.debug.warn('worker', `loop() do not decode and delay is ${I.delay}, bufferList is ` + s.length)
											break
										}
										s.shift(), I.doDecode(t)
									}
						...
						I.stopId = setInterval(() => {
							var e = new Date().getTime(),
								e = e - (_ = _ || e)
							100 < e && I.debug.warn('worker', 'loop demux diff time is ' + e), t(), (_ = new Date().getTime())
						}, 10)
					}
					I._opt.checkFirstIFrame || (c = !0)
				},
				playbackCacheLoop: function () {
					I.stopId && (clearInterval(I.stopId), (I.stopId = null))
					var e = () => {
							var e
							s.length && ((e = s.shift()), I.doDecode(e))
						},
						t = (e(), Math.ceil(1e3 / (I.streamFps * I._opt.playbackRate)))
					I.debug.log('worker', `playbackCacheLoop fragDuration is ${t}, streamFps is ${I.streamFps}, playbackRate is ` + I._opt.playbackRate),
				...
				close: function () {
					I.debug.log('worker', 'close'),
						...
						I.webglObj &&
							(I.webglObj.destroy(),
							I.offscreenCanvas.removeEventListener('webglcontextlost', I.onOffscreenCanvasWebglContextLost),
							I.offscreenCanvas.removeEventListener('webglcontextrestored', I.onOffscreenCanvasWebglContextRestored),
				...
				pushBuffer: function (e, r) {
					if (1 === r.type && fe(e)) I.decodeAudio(e, r.ts)
					else {
						if (I.isPlayer && 0 < U && 0 < S && 2 === r.type) {
							let e = r.ts - S
							e > 2 * U - 5 &&
								I.debug.warn(
									'worker',
									`pushBuffer video
                    ts is ${r.ts}, preTimestamp is ${S},
                    diff is ${e} and preTimestampDuration is ${U}
						...
						if (
							(I.isPlayer &&
								...
								(I.debug.warn(
									'worker',
									`pushBuffer,
                preTimestamp is ${S}, options.ts is ${r.ts},
                diff is ${S - r.ts} more than 3600000,
                and resetAllDelay`,
								),
								I.resetAllDelay()),
							I.isPlayer &&
								...
								I.debug.warn(
									'worker',
									`pushBuffer,
                options.ts is ${r.ts} less than (or equal) preTimestamp is ${S} and
                payloadBufferSize is ${e.byteLength} and prevPayloadBufferSize is ` + x,
								),
							I.isPlayer && c)
						) {
							let e = I._opt.videoBuffer + I._opt.videoBufferDelay,
								t = I.getDelayNotUpdateDelay(r.ts)
							;(I.pushLatestDelay = t) > e &&
								I.delay < e &&
								0 < I.delay &&
								I.hasIframeInBufferList() &&
								!1 === I.isPushDropping &&
								(I.debug.log(
									'worker',
									`pushBuffer, pushLatestDelay is ${t} more than ${e} and decoder.delay is ${I.delay} and has iIframe and next decoder.dropBuffer$2()`,
								),
								I.dropBuffer$2())
						}
						if (
							(2 === r.type && (0 < S && (U = r.ts - S), (x = e.byteLength), (S = r.ts)),
							1 === r.type
								? s.push({ ts: r.ts, payload: e, decoder: { decode: I.decodeAudio }, type: 1, isIFrame: !1 })
								: 2 === r.type &&
									s.push({ ts: r.ts, cts: r.cts, payload: e, decoder: { decode: I.decodeVideo }, type: 2, isIFrame: r.isIFrame }),
							I.isPlaybackCacheBeforeDecodeForFpsRender() && (j(I.streamVideoFps) || j(I.streamAudioFps)))
						) {
							...
							j(I.streamVideoFps) &&
								(e = _e(s, 2)) &&
								((I.streamVideoFps = e),
								postMessage({ cmd: 'playbackStreamVideoFps', value: I.streamVideoFps }),
								(I.streamFps = t ? e + t : e),
								I.playbackCacheLoop()),
								j(I.streamAudioFps) && (t = _e(s, 1)) && ((I.streamAudioFps = t), (I.streamFps = e ? e + t : t), I.playbackCacheLoop()),
								j(I.streamVideoFps) &&
									j(I.streamAudioFps) &&
									I.debug.log(
										'worker',
				...
				hasIframeInBufferList: () => s.some(e => 2 === e.type && e.isIFrame),
				...
				getFlvBufferLength() {
					let e = 0
					return h && h.buffer && (e = h.buffer.byteLength), (e = I._opt.isNakedFlow && k.lastBuf ? k.lastBuf.byteLength : e)
				},
				fetchStream: function (e, i) {
					I.debug.log('worker', 'fetchStream, url is ' + e, 'options:', JSON.stringify(i)),
						i.isFlv ? (I._opt.isFlv = !0) : i.isFmp4 ? (I._opt.isFmp4 = !0) : i.isMpeg4 && (I._opt.isMpeg4 = !0),
						(o = (r => {
							let i = 0,
								n = me()
							return e => {
							...
							postMessage({ cmd: M, type: 'streamRate', value: e })
						})),
						I.startStreamRateAndStatsInterval(),
						i.isFmp4 && (C.listenMp4Box(), I._opt.isFmp4Private) && C.initTransportDescarmber(),
						2 === i.protocol
							? ((h = new W(I.demuxFlv())),
								fetch(e, { signal: t.signal })
									.then(t => {
										if (t.ok && 200 <= t.status && t.status <= 299)
											if ((postMessage({ cmd: M, type: se }), 'undefined' != typeof WritableStream))
												t.body.pipeTo(
													new WritableStream({
														write: e => {
															o(e.byteLength), i.isFlv ? h.write(e) : i.isFmp4 ? I.demuxFmp4(e) : i.isMpeg4 && I.demuxMpeg4(e)
														},
														close: () => {
															;(h = null), n(), postMessage({ cmd: M, type: N, value: Z })
														},
														abort: e => {
															;(h = null), e.name !== he && (n(), postMessage({ cmd: M, type: O, value: e.toString() }))
														},
													}),
												)
											else {
														...
														e.read()
															.then(({ done: e, value: t }) => {
																e
																	? ((h = null), n(), postMessage({ cmd: M, type: N, value: Z }))
																	: (o(t.byteLength),
																		i.isFlv ? h.write(t) : i.isFmp4 ? I.demuxFmp4(t) : i.isMpeg4 && I.demuxMpeg4(t),
																		r())
															})
															.catch(e => {
																;(h = null), e.name !== he && (n(), postMessage({ cmd: M, type: O, value: e.toString() }))
											...
											I.debug.warn('worker', `fetch response status is ${t.status} and ok is ${t.ok} and emit error and next abort()`),
												n(),
												postMessage({ cmd: M, type: O, value: `fetch response status is ${t.status} and ok is ` + t.ok })
									})
									.catch(e => {
										e.name !== he && (n(), postMessage({ cmd: M, type: O, value: e.toString() }), (h = null))
									}))
							: 1 === i.protocol &&
								(i.isFlv && (h = new W(I.demuxFlv())),
								((r = new WebSocket(e)).binaryType = 'arraybuffer'),
								(r.onopen = () => {
									I.debug.log('worker', 'fetchStream, WebsocketStream  socket open'),
										postMessage({ cmd: M, type: se }),
										postMessage({ cmd: M, type: 'websocketOpen' })
								}),
								(r.onclose = e => {
									I.debug.log('worker', 'fetchStream, WebsocketStream socket close and code is ' + e.code),
										1006 === e.code && I.debug.warn('worker', 'fetchStream, WebsocketStream socket close abnormally and code is ' + e.code),
										(h = null),
										postMessage({ cmd: M, type: N, value: 'websocket' })
								}),
								(r.onerror = e => {
									I.debug.error('worker', 'fetchStream, WebsocketStream socket error', e),
										(h = null),
										postMessage({ cmd: M, type: 'websocketError', value: e.isTrusted ? 'websocket user aborted' : 'websocket error' })
								}),
								(r.onmessage = e => {
									o(e.data.byteLength),
										i.isFlv
				...
				demuxFlv: function* () {
					...
					for (;;) {
						...
						let e = yield 15,
							t = e[4]
						;(r[0] = e[7]), (r[1] = e[6]), (r[2] = e[5])
						var n = i[0],
							s = ((r[0] = e[10]), (r[1] = e[9]), (r[2] = e[8]), (r[3] = e[11]), i[0]),
							a = (yield n).slice()
						switch (t) {
							case 8:
								I.decode(a, { type: 1, ts: s })
								break
							case 9:
								if (0 < a.byteLength) {
									let e = a[0] >> 4 == 1,
										t =
											(I.isPlayer && (I.calcNetworkDelay(s), e) && I.calcIframeIntervalTimestamp(s),
											(i[0] = a[4]),
											(i[1] = a[3]),
											(i[2] = a[2]),
											(i[3] = 0),
										...
										r = a
									I._opt.isCrypto &&
										(I._opt.cryptoIV && 0 < I._opt.cryptoIV.byteLength && I._opt.cryptoKey && 0 < I._opt.cryptoKey.byteLength
											? (r = ((r, i, n) => {
													;(i = new Uint8Array(i)), (n = new Uint8Array(n))
													let e = r.byteLength,
														s = 5
													for (; s < e; ) {
														o = (o = r.slice(s, s + 4))[3] | (o[2] << 8) | (o[1] << 16) | (o[0] << 24)
														if (o > e) break
														var a = r[s + 4]
														if (1 == (a &= 31) || 5 == a) {
															let e = r.slice(s + 4 + 2, s + 4 + o),
																t = new Ye.ModeOfOperation.ctr(i, new Ye.Counter(n))
															a = t.decrypt(e)
															;(t = null), r.set(a, s + 4 + 2)
														}
														s = s + 4 + o
													}
													var o
													return r
												})(a, I._opt.cryptoKey, I._opt.cryptoIV))
											: I.debug.error(
													'worker',
													`cryptoKey.length is ${I._opt.cryptoKey && I._opt.cryptoKey.byteLength} or cryptoIV.length is ${I._opt.cryptoIV && I._opt.cryptoIV.byteLength} null`,
												)),
										I.decode(r, { type: 2, ts: s, isIFrame: e, cts: t })
								}
								break
							default:
				...
				decode: function (e, t) {
					1 === t.type
						? I._opt.hasAudio &&
							(postMessage({ cmd: M, type: 'streamAbps', value: e.byteLength }),
							I.isPlayer
								? I.pushBuffer(e, { type: t.type, ts: t.ts, cts: t.cts })
								: I.isPlayback &&
									(I.isPlaybackCacheBeforeDecodeForFpsRender() || 1 === I._opt.playbackRate
										? I.pushBuffer(e, { type: t.type, ts: t.ts, cts: t.cts })
										: I.decodeAudio(e, t.ts)))
						: 2 === t.type &&
							I._opt.hasVideo &&
							(postMessage({ cmd: M, type: ie, value: e.byteLength }),
							postMessage({ cmd: M, type: ne, value: t.ts }),
							I.isPlayer
								? I.pushBuffer(e, { type: t.type, ts: t.ts, isIFrame: t.isIFrame, cts: t.cts })
								: I.isPlayback &&
									(I.isPlaybackOnlyDecodeIFrame()
										? t.isIFrame && I.pushBuffer(e, { type: t.type, ts: t.ts, cts: t.cts, isIFrame: t.isIFrame })
										: (I.isPlaybackCacheBeforeDecodeForFpsRender(),
											I.pushBuffer(e, { type: t.type, ts: t.ts, cts: t.cts, isIFrame: t.isIFrame }))))
				},
				setCodecAudio: function (e) {
					var t = e[0] >> 4
					fe(e) || 7 == t || 8 == t
						? (I.debug.log('worker', 'setCodecAudio: init audio codec, codeId is ' + t),
							(e = t === G ? e.slice(2) : e.slice(1)),
							D.setCodec(t, I._opt.sampleRate, e),
							(i = !0))
						: I.debug.warn('worker', 'setCodecAudio: hasInitAudioCodec is false, codecId is ', t)
				},
				decodeAudio: function (e, t) {
					var r = e[0] >> 4
					i ? D.decode(r === G ? e.slice(2) : e.slice(1), t) : I.setCodecAudio(e)
				},
				setCodecVideo: function (e) {
					var t = 15 & e[0]
					if (I.isVideoSequenceHeader(e))
						if (7 == t || 12 == t) {
							I.debug.log('worker', 'setCodecVideo: init video codec , codecId is ' + t)
							var r = e.slice(5)
							...
							;(p = !0), P.setCodec(t, r), I._opt.recordType === z && postMessage({ cmd: re, buffer: e, codecId: t }, [e.buffer])
						} else I.debug.warn('worker', `setCodecVideo: hasInitVideoCodec is false, codecId is ${t} is not H264 or H265`)
					else
						I.debug.warn(
							'worker',
				...
				decodeVideo: function (r, e, t, i) {
					if (p)
						if ((c = !c && t ? !0 : c)) {
							if (t && I.isVideoSequenceHeader(r)) {
								let e = 15 & r[0],
									t = {}
								7 == e
									? (t = be(r.slice(5)))
									: 12 == e &&
										(t = (e => {
											...
											do {
												...
												if (((n.configurationVersion = e[0]), 1 != n.configurationVersion)) break
												;(n.general_profile_space = (e[1] >> 6) & 3),
													(n.general_tier_flag = (e[1] >> 5) & 1),
													(n.general_profile_idc = 31 & e[1]),
													(n.general_profile_compatibility_flags = (e[2] << 24) | (e[3] << 16) | (e[4] << 8) | e[5]),
													(n.general_constraint_indicator_flags = (e[6] << 24) | (e[7] << 16) | (e[8] << 8) | e[9]),
													(n.general_constraint_indicator_flags =
														(n.general_constraint_indicator_flags << 16) | (e[10] << 8) | e[11]),
													(n.general_level_idc = e[12]),
													(n.min_spatial_segmentation_idc = ((15 & e[13]) << 8) | e[14]),
													(n.parallelismType = 3 & e[15]),
													(n.chromaFormat = 3 & e[16]),
													(n.bitDepthLumaMinus8 = 7 & e[17]),
													(n.bitDepthChromaMinus8 = 7 & e[18]),
													(n.avgFrameRate = (e[19] << 8) | e[20]),
													(n.constantFrameRate = (e[21] >> 6) & 3),
													(n.numTemporalLayers = (e[21] >> 3) & 7),
													(n.temporalIdNested = (e[21] >> 2) & 1),
													(n.lengthSizeMinusOne = 3 & e[21])
												let t = e[22],
													r = e.slice(23)
													...
													for (let e = 0; e < a && !(r.length < 2); e++) {
														...
														;(r = r.slice(2)),
															33 == s &&
																...
																(n.psps = Ae(o)),
																(i.profile = n.general_profile_idc),
																(i.level = n.general_level_idc / 30),
																(i.width =
																	n.psps.pic_width_in_luma_samples -
																	(n.psps.conf_win_left_offset + n.psps.conf_win_right_offset)),
																(i.height =
																	n.psps.pic_height_in_luma_samples -
																	(n.psps.conf_win_top_offset + n.psps.conf_win_bottom_offset))),
															(r = r.slice(l))
													}
												}
											} while (0)
									...
									t.codecWidth &&
										...
										u &&
										f &&
										(t.codecWidth !== u || t.codecHeight !== f) &&
										(I.debug.warn(
											'worker',
											`
                            decodeVideo: video width or height is changed,
                            old width is ${u}, old height is ${f},
                            new width is ${t.codecWidth}, new height is ${t.codecHeight},
							...
							var n
							A
								? I.debug.warn('worker', 'decodeVideo: video width or height is changed, and return')
								: I.isVideoSequenceHeader(r)
									? I.debug.warn('worker', 'decodeVideo and payload is video sequence header so drop this frame')
									: r.byteLength < 12
										? I.debug.warn('worker', 'decodeVideo and payload is too small , payload length is ' + r.byteLength)
										: ((n = r.slice(5)),
											P.decode(n, t ? 1 : 0, e),
											I._opt.isRecording &&
												I._opt.recordType === z &&
												postMessage({ cmd: 'videoNalu', buffer: n, isIFrame: t, ts: e, cts: i }, [r.buffer]))
						} else I.debug.warn('worker', 'decodeVideo: first frame is not iframe')
					else I.setCodecVideo(r)
				},
				clearBuffer: function (e = !1) {
					I.debug.log('worker', `clearBuffer,bufferList length is ${s.length}, need clear is ` + e),
						e && (s = []),
						I.resetAllDelay(),
						(I.dropping = !0)
				},
				dropBuffer$2: function () {
					if (0 < s.length) {
						I.isPushDropping = !0
						let t = s.findIndex(e => ge(e.isIFrame) && 2 === e.type)
						...
						0 <= t
							? ((e = (s = s.slice(t)).shift()),
								(i = I.getDelayNotUpdateDelay(e.ts)),
								I.doDecode(e),
								(I.isPushDropping = !1),
								I.debug.log(
									'worker',
									`dropBuffer$2() iFrameIndex is ${t},and bufferList length is ${s.length} and tempDelay is ${i} ,delay is ${I.delay} `,
								))
							: (I.isPushDropping = !1)
					}
					0 === s.length && (I.isPushDropping = !1)
				},
				demuxM7s: function (e) {
					var t,
						r = new DataView(e),
					...
					switch (r.getUint8(0)) {
						case 1:
							I.decode(new Uint8Array(e, 5), { type: 1, ts: i })
							break
						case 2:
							5 < r.byteLength &&
								((t = r.getUint8(5) >> 4 == 1),
								I.isPlayer && (I.calcNetworkDelay(i), t) && I.calcIframeIntervalTimestamp(i),
								I.decode(new Uint8Array(e, 5), { type: 2, ts: i, isIFrame: t }))
					}
				},
				...
				calcNetworkDelay: function (e) {
					...
					c &&
						...
						(null === g
							? ((g = e), (y = ce()))
							: e < g && (I.debug.warn('worker', `calcNetworkDelay, dts is ${e} less than bufferStartDts is ` + g), (g = e), (y = ce())),
						(i = (t = e - g) < (r = ce() - y) ? r - t : 0),
						(I.networkDelay = i) > I._opt.networkDelay) &&
						I._opt.playType === L &&
						(I.debug.warn('worker', `calcNetworkDelay now dts:${e}, start dts is ${g} vs start is ${t},local diff is ${r} ,delay is ` + i),
						postMessage({ cmd: M, type: 'networkDelayTimeout', value: i }))
				},
				calcIframeIntervalTimestamp: function (e) {
					null === E ? (E = e) : E < e && (postMessage({ cmd: 'iframeIntervalTs', value: e - E }), (E = e))
				},
				canVisibilityDecodeNotDrop: function () {
					return I._opt.visibility && u * f <= 2073600
				},
				isPlaybackCacheBeforeDecodeForFpsRender: function () {
					return !I.isPlayer && I._opt.playbackIsCacheBeforeDecodeForFpsRender
				},
				...
				isVideoSequenceHeader: function (e) {
					return e[0] >> 4 == 1 && e[1] === ue
				},
				onOffscreenCanvasWebglContextLost: function (e) {
					I.debug.error('worker', 'handleOffscreenCanvasWebglContextLost and next try to create webgl'),
						e.preventDefault(),
						(B = !0),
						I.webglObj.destroy(),
						(I.webglObj = null),
						...
						setTimeout(() => {
							;(I.offscreenCanvasGL = I.offscreenCanvas.getContext('webgl')),
								I.offscreenCanvasGL && I.offscreenCanvasGL.getContextAttributes().stencil
									? ((I.webglObj = X(I.offscreenCanvasGL, I._opt.openWebglAlignment)), (B = !1))
									: I.debug.error('worker', 'handleOffscreenCanvasWebglContextLost, stencil is false')
						}, 500)
				},
				...
				videoInfo: function (e, t, r) {
					postMessage({ cmd: te, code: e }),
						postMessage({ cmd: Q, w: t, h: r }),
						(u = t),
						(f = r),
						I.useOffscreen() &&
							((I.offscreenCanvas = new OffscreenCanvas(t, r)),
							(I.offscreenCanvasGL = I.offscreenCanvas.getContext('webgl')),
							(I.webglObj = X(I.offscreenCanvasGL, I._opt.openWebglAlignment)),
							I.offscreenCanvas.addEventListener('webglcontextlost', I.onOffscreenCanvasWebglContextLost, !1),
							I.offscreenCanvas.addEventListener('webglcontextrestored', I.onOffscreenCanvasWebglContextRestored, !1))
				},
				audioInfo: function (e, t, r) {
					postMessage({ cmd: 'audioCode', code: e }), postMessage({ cmd: 'initAudio', sampleRate: t, channels: r }), (w = r)
				},
				yuvData: function (e, t) {
					if (I.isDestroyed) I.debug.log('worker', 'yuvData, decoder is destroyed and return')
					else {
						var r,
							i = (u * f * 3) / 2,
						...
						if (I.useOffscreen())
							try {
								B ||
									(I.webglObj.renderYUV(u, f, i),
									(r = I.offscreenCanvas.transferToImageBitmap()),
									postMessage({ cmd: R, buffer: r, delay: I.delay, ts: t }, [r]))
							} catch (e) {
								I.debug.error('worker', 'yuvData, transferToImageBitmap error is', e)
							}
						else postMessage({ cmd: R, output: i, delay: I.delay, ts: t }, [i.buffer])
					}
				},
				pcmData: function (n, s, a) {
					if (I.isDestroyed) I.debug.log('worker', 'pcmData, decoder is destroyed and return')
					else {
						let t = s,
							r = [],
							e = 0,
						...
						if (v) {
							if (!(t >= (s = i - v)))
								return (v += t), (d[0] = Float32Array.of(...d[0], ...r[0])), void (2 == w && (d[1] = Float32Array.of(...d[1], ...r[1])))
							;(b[0] = Float32Array.of(...d[0], ...r[0].subarray(0, s))),
								2 == w && (b[1] = Float32Array.of(...d[1], ...r[1].subarray(0, s))),
								postMessage(
									{ cmd: ee, buffer: b, ts: a },
									b.map(e => e.buffer),
								),
								(e = s),
								(t -= s)
						...
						for (v = t; v >= i; v -= i)
							(b[0] = r[0].slice(e, (e += i))),
								2 == w && (b[1] = r[1].slice(e - i, e)),
								postMessage(
									{ cmd: ee, buffer: b, ts: a },
									b.map(e => e.buffer),
								)
						v && ((d[0] = r[0].slice(e)), 2 == w) && (d[1] = r[1].slice(e))
					}
				},
			...
			D = ((I.debug = new ye(I)), null),
			P = (l.AudioDecoder && (D = new l.AudioDecoder(I)), null)
		l.VideoDecoder && (P = new l.VideoDecoder(I)),
				...
				switch (t.cmd) {
					...
					case 'updateConfig':
						I.debug.log('worker', 'updateConfig', t.key, t.value),
							...
							'playbackRate' === t.key && (I.playbackUpdatePlaybackRate(), I.isPlaybackCacheBeforeDecodeForFpsRender()) && I.playbackCacheLoop()
						break
					case 'sendWsMessage':
