		...
		var c = (function (b) {
			...
			d = (function (a) {
				...
				function q(a, b, c) {
					...
					switch (
						(j || ((j = d('rect')), d(j, { x: -9e9, y: -9e9, width: 10, height: 10, class: 'svg---mgr', fill: 'none' }), h.appendChild(j)), a.type)
					) {
						case 'rect':
							g('rx', e), g('ry', f)
						case 'image':
				...
				;(c._.$ = d),
					...
					(c.closestPoint = function (a, b, c) {
						...
						for (
							var e, f, g, h, i = a.node, j = i.getTotalLength(), k = (j / i.pathSegList.numberOfItems) * 0.125, l = 1 / 0, m = 0;
							j >= m;
							m += k
						)
		...
		return (
				...
				;(a.deurl = function (a) {
					...
					b.on('snap.util.attr.mask', function (a) {
						if (a instanceof c || a instanceof f) {
							if (
								(b.stop(),
								a instanceof f && 1 == a.node.childNodes.length && ((a = a.node.firstChild), n(this).appendChild(a), (a = l(a))),
								'mask' == a.type)
							)
								var d = a
				...
				b.on('snap.util.attr', function (a) {
					...
					if (c) {
						...
						var h = c[3] || '',
							...
							n = i[c[1]]
						if (
							(m && m == h ? (a = n(parseFloat(f), +c[2])) : ((f = this.asPX(e)), (a = n(this.asPX(e), this.asPX(e, c[2] + h)))),
							isNaN(f) || isNaN(a))
						)
							return
						;(g[e] = a), this.attr(g)
						...
						;(h.gradient = function (a) {
							...
							(h.clear = function () {
								for (var a, b = this.node.firstChild; b; )
									(a = b.nextSibling), 'defs' != b.tagName ? b.parentNode.removeChild(b) : h.clear.call({ node: b }), (b = a)
							})
					})()
			}),
			d.plugin(function (a, b, c, d) {
				...
				function s(a, b, c) {
					...
					if (!n(d, e)) return c ? 0 : []
					for (
						var f = p.apply(0, a), g = p.apply(0, b), h = ~~(f / 8), i = ~~(g / 8), j = [], m = [], o = {}, q = c ? 0 : [], s = 0;
						h + 1 > s;
						s++
					) {
				...
				function B(b) {
					...
					for (
						var n, o, p = 3 == b.length && 'M' == b[0][0] && 'R' == b[1][0].toUpperCase() && 'Z' == b[2][0].toUpperCase(), q = m, r = b.length;
						r > q;
						q++
					) {
				...
				;(p.stroke = p.fill = 'colour'),
					...
					b.on('snap.util.equal', function (b, c) {
						var d,
							...
							s = this
						if ('colour' == p[b])
							return (d = a.color(f)), (e = a.color(c)), { from: [d.r, d.g, d.b, d.opacity], to: [e.r, e.g, e.b, e.opacity], f: k }
				...
				for (
					...
					!(function (b) {
						;(a[b] = f[b] =
							function (c, d) {
								if (a.is(c, 'function'))
									(this.events = this.events || []), this.events.push({ name: b, f: c, unbind: n(this.node || document, b, c, d || this) })
								else
				...
				;(f.drag = function (c, d, e, f, g, h) {
					...
					(f.undrag = function () {
						for (var c = s.length; c--; )
							s[c].el == this &&
								(this.unmousedown(s[c].init), s.splice(c, 1), b.unbind('snap.drag.*.' + this.id), b.unbind('snap.draginit.' + this.id))
