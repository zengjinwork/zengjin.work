					...
					n(Sha256, i),
						...
						(Sha256.prototype._update = function (t) {
							...
							for (; h < 64; ++h)
								r[h] =
									0 |
									(((((e = r[h - 2]) >>> 17) | (e << 15)) ^ ((e >>> 19) | (e << 13)) ^ (e >>> 10)) + r[h - 7] + gamma0(r[h - 15]) + r[h - 16])
							for (var p = 0; p < 64; ++p) {
					...
					;(e.Children = {
						...
						(e.cloneElement = function (t, e, n) {
							...
							var i = _({}, t.props),
								...
								s = t._owner
							if (null != e) {
								if ((void 0 !== e.ref && ((a = e.ref), (s = b.current)), void 0 !== e.key && (o = '' + e.key), t.type && t.type.defaultProps))
			...
			(() => {
				...
				var xt = new it('tag:yaml.org,2002:binary', {
						...
						construct: function constructYamlBinary(t) {
							var e,
								...
								s = []
							for (e = 0; e < i; e++)
								e % 4 == 0 && e && (s.push((a >> 16) & 255), s.push((a >> 8) & 255), s.push(255 & a)), (a = (a << 6) | o.indexOf(n.charAt(e)))
							return (
								0 === (r = (i % 4) * 6)
				...
				function storeMappingPair(t, e, r, n, i, o, a, s, u) {
					...
					if (
						...
						t.json ||
							Lt.call(r, i) ||
							!Lt.call(e, i) ||
							((t.line = a || t.line), (t.lineStart = s || t.lineStart), (t.position = u || t.position), throwError(t, 'duplicated mapping key')),
				...
				function readDocument(t) {
					...
					for (
						...
						for (
							n = [],
								(r = t.input.slice(e, t.position)).length < 1 && throwError(t, 'directive name must not be less than one character in length');
							0 !== i;
				...
				const ie = console.error,
					withErrorBoundary = t => e => {
						...
						class WithErrorBoundary extends n.Component {
							render() {
								return n.createElement(o, { targetName: a, getComponent: r, fn: i }, n.createElement(e, ne()({}, this.props, this.context)))
							}
						}
						var s
						return (
				...
				class ErrorBoundary extends n.Component {
					static defaultProps = { targetName: 'this component', getComponent: () => fallback, fn: { componentDidCatch: ie }, children: null }
