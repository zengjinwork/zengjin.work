...
*/
	...
	function xc(a) {
		...
		'' !== X &&
			X !== a &&
			(console.warn(" Attempting to load version '" + a + "' of Google Charts, but the previously loaded '" + (X + "' will be used instead.")), (a = X))
		return (X = a || '')
	}
	function yc(a) {
		a = a || ''
		'' !== Y &&
			Y !== a &&
			(console.warn(" Attempting to load Google Charts for language '" + a + "', but the previously loaded '" + (Y + "' will be used instead.")), (a = Y))
		'en' === a && (a = '')
		return (Y = a || '')
	}
	function zc(a) {
