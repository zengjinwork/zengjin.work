		...
		function (t, e, i) {
			...
			return (
				...
				(_.progress = function (t) {
					return arguments.length
						? this.totalTime(
								this.duration() * (this._yoyo && 0 !== (1 & this._cycle) ? 1 - t : t) + this._cycle * (this._duration + this._repeatDelay),
								!1,
							)
			...
			function (t, e, i) {
				...
				return (
					...
					(d.add = function (r, n, a, o) {
						...
						if (
							(e.prototype.add.call(this, r, n), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())
						)
			...
			init: function (t, e) {
				...
				for (i in e)
					'useRadians' !== i &&
						...
						(s = o[0]),
						(r = parseFloat(
							'function' != typeof t[i] ? t[i] : t[i.indexOf('set') || 'function' != typeof t['get' + i.substr(3)] ? i : 'get' + i.substr(3)](),
						)),
						(n = this.finals[i] =
